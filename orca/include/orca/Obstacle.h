...
namespace RVO {
	...
	private:
		...
		bool isConvex_;
		Obstacle *nextObstacle_;   // %%% Why need this?  ANS = Every obstacle point is an obstacle. So they have linked subsequent obstacle points together
		Vector2 point_;
		Obstacle *prevObstacle_;   // %%% WHY need this?
		Vector2 unitDir_;
